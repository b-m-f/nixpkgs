...
A short (one-line) description of the package. This is shown on the [NixOS search page](https://search.nixos.org/packages?show=hello) and also on the Nixpkgs release pages.
